...
* Introduced energy into pathfinding algorithm by basing cost of node by distance so far to node, heuristic to end node, anod now the energy required by the UAV. ( F(n) = g(n) + h(n) + e(n) )
* 
