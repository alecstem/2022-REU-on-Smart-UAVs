...
class S3QueryBase(abc.ABC):
        ...
        def __init__(
            ...
            download_limit_gbytes: typing.Union[int, float] = .01,
            verbose: bool = False,
        ):
        ...
        def run(self, dataset_name: str = None):
            ...
            if dataset_name is not None:
                ...
                ########################################
                    ...
                    print("function 1 is running") #this runs along with #3
                    #lets try and run it for a set time and then terminate it
        ...
        def download_dataset_by_name(self, dataset_name: str):
            ...
            if self.search_polygon is None:
                ...
                ########################################
                    ...
                    #p.start()
                ########################################
                    print("function 3 is running") #this one runs along with #1
                ...
                for json_dataset in json_response["Datasets"]:
                    ...
                    if dataset_prefix == dataset_name:
                        i = 0
                        while i < 1:               #need to find where the file size is
        ...
        def download_dataset(self, dataset_prefix, client):
            ...
            assert lidar_size_bytes > self.download_limit_gbytes, (
                ...
                if self.redownload_files_bool or not local_path.exists():
                    ...
                    if self.verbose:
                        ...
                        #try:
                            ...
                            las = laspy.read('C:\\Users\\lcbba\\PycharmProjects\\pythonProject\\laz_files' + '\\' + str(file_prefix))
                            #print('C:\\Users\\lcbba\\PycharmProjects\\pythonProject\\laz_files' + '\\' + str(file_prefix))
                            las = laspy.convert(las)
                            las.write('C:\\Users\\lcbba\\PycharmProjects\\full_test\\full_test\\this_file.las')
                            print("hi 2")
                            break
                                #i += 2
                                #print(i)
